...
import { IThemeService, themeColorFromId } from 'monaco-editor/esm/vs/platform/theme/common/themeService.js';
...
import { shouldSynchronizeModel, OverviewRulerLane, MinimapPosition } from 'monaco-editor/esm/vs/editor/common/model.js';
...
let DirtyDiffWidget = class DirtyDiffWidget extends PeekViewWidget {
    ...
    updateActions() {
        ...
        this._actionbarWidget.push(( new Action('peekview.close', ( nls.localizeWithPath(
            'vs/workbench/contrib/scm/browser/dirtydiffDecorator',
            'label.close',
            "Close"
...
const overviewRulerModifiedForeground = registerColor('editorOverviewRuler.modifiedForeground', { dark: ( transparent(editorGutterModifiedBackground, 0.6)), light: ( transparent(editorGutterModifiedBackground, 0.6)), hcDark: ( transparent(editorGutterModifiedBackground, 0.6)), hcLight: ( transparent(editorGutterModifiedBackground, 0.6)) }, ( nls.localizeWithPath(
    'vs/workbench/contrib/scm/browser/dirtydiffDecorator',
    'overviewRulerModifiedForeground',
    'Overview ruler marker color for modified content.'
)));
const overviewRulerAddedForeground = registerColor('editorOverviewRuler.addedForeground', { dark: ( transparent(editorGutterAddedBackground, 0.6)), light: ( transparent(editorGutterAddedBackground, 0.6)), hcDark: ( transparent(editorGutterAddedBackground, 0.6)), hcLight: ( transparent(editorGutterAddedBackground, 0.6)) }, ( nls.localizeWithPath(
    'vs/workbench/contrib/scm/browser/dirtydiffDecorator',
    'overviewRulerAddedForeground',
    'Overview ruler marker color for added content.'
)));
const overviewRulerDeletedForeground = registerColor('editorOverviewRuler.deletedForeground', { dark: ( transparent(editorGutterDeletedBackground, 0.6)), light: ( transparent(editorGutterDeletedBackground, 0.6)), hcDark: ( transparent(editorGutterDeletedBackground, 0.6)), hcLight: ( transparent(editorGutterDeletedBackground, 0.6)) }, ( nls.localizeWithPath(
    'vs/workbench/contrib/scm/browser/dirtydiffDecorator',
