...
import { Throttler, Delayer, Promises } from 'monaco-editor/esm/vs/base/common/async.js';
...
import { INSTALL_ACTIONS_GROUP, THEME_ACTIONS_GROUP, VIEWLET_ID, IExtensionsWorkbenchService, TOGGLE_IGNORE_EXTENSION_ACTION_ID, SELECT_INSTALL_VSIX_EXTENSION_COMMAND_ID } from '../common/extensions.js';
...
import { ActionWithDropdownActionViewItem } from 'monaco-editor/esm/vs/base/browser/ui/dropdown/dropdownActionViewItem.js';
...
let SkipUpdateAction = class SkipUpdateAction extends AbstractUpdateAction {
    constructor(extensionsWorkbenchService) {
        super(`extensions.ignoreUpdates`, ( localizeWithPath(
            'vs/workbench/contrib/extensions/browser/extensionsActions',
            'ignoreUpdates',
            "Ignore Updates"
        )), extensionsWorkbenchService);
...
let SwitchToPreReleaseVersionAction = class SwitchToPreReleaseVersionAction extends ExtensionAction {
    ...
    constructor(icon, commandService) {
        super(SwitchToPreReleaseVersionAction_1.ID, icon ? '' : SwitchToPreReleaseVersionAction_1.TITLE.value, `${icon ? ExtensionAction.ICON_ACTION_CLASS + ' ' + ThemeIcon.asClassName(preReleaseIcon) : ExtensionAction.LABEL_ACTION_CLASS} hide-when-disabled switch-to-prerelease`, true);
        this.commandService = commandService;
        this.tooltip = ( localizeWithPath(
            'vs/workbench/contrib/extensions/browser/extensionsActions',
...
SwitchToPreReleaseVersionAction = SwitchToPreReleaseVersionAction_1 = ( __decorate([
...
let SwitchToReleasedVersionAction = class SwitchToReleasedVersionAction extends ExtensionAction {
    ...
    constructor(icon, commandService) {
        super(SwitchToReleasedVersionAction_1.ID, icon ? '' : SwitchToReleasedVersionAction_1.TITLE.value, `${icon ? ExtensionAction.ICON_ACTION_CLASS + ' ' + ThemeIcon.asClassName(preReleaseIcon) : ExtensionAction.LABEL_ACTION_CLASS} hide-when-disabled switch-to-released`);
        this.commandService = commandService;
        this.tooltip = ( localizeWithPath(
            'vs/workbench/contrib/extensions/browser/extensionsActions',
...
SwitchToReleasedVersionAction = SwitchToReleasedVersionAction_1 = ( __decorate([
    ( __param(1, ICommandService))
