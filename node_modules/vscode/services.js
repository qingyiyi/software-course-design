...
import getServiceOverride$1$1 from '@codingame/monaco-vscode-environment-service-override';
import getServiceOverride$2 from '@codingame/monaco-vscode-extensions-service-override';
import getServiceOverride$1$2 from '@codingame/monaco-vscode-files-service-override';
...
async function initialize(overrides, container = document.body, configuration = {}) {
    checkServicesNotInitialized();
    initialize$1(container, configuration);
...
export { createInstance, createInstanceSync, getService, initialize, withReadyServices };
