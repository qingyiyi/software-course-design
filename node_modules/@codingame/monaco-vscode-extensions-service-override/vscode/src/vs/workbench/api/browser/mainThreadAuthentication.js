...
import { getAuthenticationProviderActivationEvent, addAccountUsage, readAllowedExtensions, readAccountUsages, removeAccountUsage } from 'vscode/vscode/vs/workbench/services/authentication/browser/authenticationService';
...
class MainThreadAuthenticationProvider extends Disposable {
    ...
    manageTrustedExtensions(accountName) {
        ...
        if (!allowedExtensions.length) {
            this.dialogService.info(( nls.localizeWithPath(
        ...
        quickPick.customLabel = ( nls.localizeWithPath(
            'vs/workbench/api/browser/mainThreadAuthentication',
        ...
        quickPick.title = ( nls.localizeWithPath(
            'vs/workbench/api/browser/mainThreadAuthentication',
