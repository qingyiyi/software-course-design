...
import { IListService, WorkbenchObjectTree } from 'monaco-editor/esm/vs/platform/list/browser/listService.js';
...
const COMMENTS_VIEW_TITLE = ( nls.localizeWithPath(
...
let CommentNodeRenderer = class CommentNodeRenderer {
    ...
    getRenderedComment(commentBody, disposables) {
        ...
        for (let i = 0; i < images.length; i++) {
            ...
            textDescription.textContent = image.alt ? ( nls.localizeWithPath(
                'vs/workbench/contrib/comments/browser/commentsTreeViewer',
                'imageWithLabel',
                "Image: {0}",
                image.alt
    ...
    renderElement(node, index, templateData, height) {
        ...
        if (node.element.range) {
            if (node.element.range.startLineNumber === node.element.range.endLineNumber) {
                templateData.threadMetadata.range.textContent = ( nls.localizeWithPath(
                    'vs/workbench/contrib/comments/browser/commentsTreeViewer',
                    'commentLine',
                    "[Ln {0}]",
        ...
        templateData.repliesMetadata.lastReplyDetail.textContent = ( nls.localizeWithPath(
            'vs/workbench/contrib/comments/browser/commentsTreeViewer',
            'lastReplyFrom',
            "Last reply from {0}",
