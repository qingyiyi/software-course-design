...
const collapseIcon = registerIcon('review-comment-collapse', Codicon.chevronUp, ( nls.localizeWithPath(
...
class CommentThreadHeader extends Disposable {
    ...
    _fillHead() {
        ...
        this._collapseAction = ( new Action('review.expand', ( nls.localizeWithPath(
            'vs/workbench/contrib/comments/browser/commentThreadHeader',
            'label.collapse',
            "Collapse"
