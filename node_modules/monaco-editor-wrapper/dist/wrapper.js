...
import { mergeServices } from 'monaco-languageclient';
...
export class MonacoEditorLanguageClientWrapper {
    id;
    editorApp;
    languageClientWrapper = new LanguageClientWrapper();
    logger;
    initDone = false;
    /**
    ...
    async init(userConfig) {
        ...
        const serviceConfig = userConfig.wrapperConfig.serviceConfig ?? {};
